...
import { DEFAULT_FASTIFY_RENDER_PATH, DEFAULT_ROOT_PATH } from '../serve-static.constants.js';
...
let FastifyLoader = class FastifyLoader extends AbstractLoader {
    register(httpAdapter, config, optionsArr) {
        const app = httpAdapter.getInstance();
        const globalPrefix = config.getGlobalPrefix();
        const fastifyStatic = loadPackageSync('@fastify/static', 'ServeStaticModule', () => require('@fastify/static'));
